...
<div class="admin-wrapper" style="max-width: 600px;">
    <div class="breadcrumb">
        ...
        <span class="sep">/</span>
        <span class="current">Chỉnh sửa #${category.id}</span>
    </div>
    ...
    <div class="form-card">
        <div class="form-card-header" style="background: linear-gradient(135deg, #0f4c81 0%, #1d4ed8 100%);">
            ...
            <a href="${pageContext.request.contextPath}/admin/category/list" class="btn-header-back">&#8592; Quay lại</a>
        </div>
                ...
                <div class="form-group">
                    ...
                    <c:if test="${not empty category.icon}">
                        <div class="current-image-row">
                            <img src="${pageContext.request.contextPath}/image?fname=${category.icon}" alt="Icon hiện tại" />
                            <div class="info">
