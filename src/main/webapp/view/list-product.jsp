...
<div class="admin-wrapper">
	<div class="admin-page-header">
		<div>
			...
			<p class="sub">
				Tổng cộng <strong>${fn:length(products)}</strong> sản phẩm trong hệ
				thống
			</p>
		</div>
		<a href="${pageContext.request.contextPath}/admin/product/add"
			class="btn-add-new"> &#43; Thêm sản phẩm mới </a>
	</div>
					...
					<c:when test="${not empty products}">
						<c:forEach items="${products}" var="p" varStatus="st">
							<tr>
								...
								<td class="col-price"><fmt:formatNumber value="${p.price}"
										type="number" /> đ</td>
								<td><c:choose>
								...
								<td><span class="badge badge-cate">${p.category.catename}</span>
								</td>
						...
						<tr>
							<td colspan="7">
								<div class="empty-state">
									<div class="icon">📦</div>
									<p>
										Chưa có sản phẩm nào. Hãy bấm <strong>+ Thêm sản phẩm
											mới</strong> để bắt đầu!
									</p>
								</div>
							</td>
						</tr>
