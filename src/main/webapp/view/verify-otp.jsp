...
<body class="auth-wrap">
    <div class="auth-card">
        ...
        <div class="otp-timer">
            Mã đã gửi tới <strong>${sessionScope.otpUser}</strong> &mdash; hiệu lực <strong>5 phút</strong>
        </div>

        <form action="${pageContext.request.contextPath}/verify-otp" method="post">
            <div class="form-group">
                <label style="text-align:center; display:block;">Mã OTP</label>
                <input class="form-control otp-input" name="otp" maxlength="6"
                       required placeholder="______" autocomplete="one-time-code">
            </div>
        ...
        <form action="${pageContext.request.contextPath}/verify-otp" method="post" style="margin-top:10px">
            ...
            <button class="btn btn-secondary btn-block" type="submit">Gửi lại mã OTP</button>
        </form>
