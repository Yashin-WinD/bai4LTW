...
<div class="auth-card">
	...
	<form action="${pageContext.request.contextPath}/login" method="post">
		...
		<div class="form-group"
			...
			<input type="checkbox" name="remember" id="remember"
				style="width: 16px; height: 16px; accent-color: #4f46e5;"> <label
				for="remember"
				style="margin: 0; font-weight: 600; color: #64748b; font-size: 13px; cursor: pointer;">Ghi
				nhớ đăng nhập</label>
		</div>
	...
	<div class="auth-links">
		<a href="${pageContext.request.contextPath}/register">Đăng ký tài
			khoản</a> <span class="sep">·</span> <a
			href="${pageContext.request.contextPath}/forgot-password">Quên
			mật khẩu?</a> <span class="sep">·</span> <a
